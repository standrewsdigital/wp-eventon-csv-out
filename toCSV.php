...
// for each event
 while($events->have_posts()){
    ...
    $dataOutStatus = true; // is the data ok to be exported 
    // echo "<td>$row</td>";
...
// var  evcal_rep_freq  val frequency
 ...
 //       echo "<td>$dataOut[34]</td>";
   ...
   // ------------      repeatby  ------------//
   // var evp_repeat_rb val repeatby
